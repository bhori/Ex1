...
public class ComplexFunctionTest111 {
	...
	public static void main(String[] args) {
		...
		ComplexFunction cf2 = new ComplexFunction(Operation.Times, p1, p2);
		...
		ComplexFunction cf8 = new ComplexFunction(Operation.None, p1, p2);

		System.out.println(cf1.getOp());
		System.out.println(cf2.getOp());
		System.out.println(cf3.getOp());
		System.out.println(cf4.getOp());
		System.out.println(cf5.getOp());
		System.out.println(cf6.getOp());
		System.out.println(cf7.getOp());
		System.out.println(cf8.getOp());
